    ...
    return (
        <div className={s.reviews}>
            <div className="container">
                <Image src="/rectangle-deco.svg" width={32} height={1} className={s.reviews_rectangle_deco}/>
                    ...
                    {reviews.map((item) => (
                        <SwiperSlide key={item.id}>
                            <div className={s.reviews_swiper_slide}>
                                <Image src={item.img} width={400} height={400} className={s.reviews_swiper_slide_img} />
                                <div className={s.reviews_swiper_slide_content}>
                                    <h2 className={s.reviews_swiper_slide_title}>Best! I got the house I wanted through Hounter</h2>
                                    <p className={s.reviews_swiper_slide_desc}>Through this website I can get a house with the type and specifications I want very easily, without a complicated process to be able to find information on the house we want.</p>
                                    <div className={s.reviews_swiper_slide_user}>
                                        <Image src={item.pfp} width={104} height={104} />
                                        <div>
                                            <h3 className={s.reviews_swiper_slide_user_name}>{item.name}</h3>
                                            <p className={s.reviews_swiper_slide_user_role}>{item.role}</p>
                                        </div>
                                        ...
                                        <h4 className={s.reviews_swiper_slide_rating}>{item.rating}</h4>
                                    </div>
                                </div>
                            </div>
                        </SwiperSlide>
