            ...
            <div className="container">
                <div className={s.benefits_wrapper}>
                    <div className={s.benefits_list}>
                        <Image src="/dot-ornament.svg" className={s.benefits_dot_ornament} width={90} height={100} />
                        <Image src="/rectangle-deco.svg" className={s.benefits_rectangle_deco} width={32} height={1} />
