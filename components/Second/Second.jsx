        ...
        <div>
            <div className={s.recommendations}>
                <div className="container">
                    <div className={s.recommendations_content}>
                        <Image src="/rectangle-deco.png" width={32} height={1} className={s.rectangle_deco} />
                        <div className={s.recommendations_nav}>
                            <div>
                                <h6 className={s.recommendations_desc}>Our Recommendation</h6>
                                <h2 className={s.recommendations_title}>Featured House</h2>
                            </div>
                            {secondNav.map((item) => (
                                <button key={item.id} className={s.recommendations_nav_btn}>
                                    {item.img}
                                    <span>{item.label}</span>
                                </button>
                            ))}
                            <div className={s.recommendations_swiper_nav}>
                                <button className={`${s.recommendations_swiper_next} ${s.recommendations_swiper_nav_btn}`}>
                                    <svg
                                        width="28"
                                        height="28"
                                        viewBox="0 0 28 28"
                                ...
                                <button className={`${s.recommendations_swiper_prev} ${s.recommendations_swiper_nav_btn}`}>
                                    <svg
                                        width="28"
                                        height="28"
                                        viewBox="0 0 28 28"
                        ...
                        <div className="recommendations_swiper">
                            <Swiper
                                loop
                                navigation={{
                                    prevEl: `.${s.recommendations_swiper_prev}`,
                                    nextEl: `.${s.recommendations_swiper_next}`,
                                }}
                                slidesPerView={4}
                                speed={700}
                                modules={[Navigation]}
                                ...
                                className="recommendations_swiper"
                                spaceBetween={20}
                            >
                                {featuredHouses.map((item) => (
                                    <SwiperSlide key={item.id}>
                                        <div className={s.recommendations_swiper_slide}>
                                            <div className={s.recommendations_swiper_slide_house}>
                                                <Image src={item.img} width={340} height={382} />
                                                <h3 className={s.recommendations_swiper_slide_title}>{item.title}</h3>
                                                <p className={s.recommendations_swiper_slide_price}>{item.price}</p>
                                            </div>
                                            <div className={s.recommendations_swiper_slide_seller}>
                                                <Image className={s.recommendations_swiper_slide_pfp} src={item.pfp} width={40} height={40} />
                                                <div>
                                                    <h3 className={s.recommendations_swiper_slide_sellerName}>{item.sellerName}</h3>
                                                    <p className={s.recommendations_swiper_slide_address}>{item.address}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </SwiperSlide>
